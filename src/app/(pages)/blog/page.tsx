...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Discover insights, tutorials, and thoughts about web development, technology, and modern programming practices.",
    type: "website",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Discover insights, tutorials, and thoughts about web development and modern programming practices.",
  },
  alternates: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Web development articles, tutorials, and insights about modern programming technologies",
            ...
            potentialAction: {
              "@type": "SearchAction",
              target:
                "https://umarsiddiqui.dev/blog?search={search_term_string}",
