...
// We'll add a separate metadata file for the blog page
  ...
  <div className="animate-pulse bg-white/50 dark:bg-neutral-800/50 backdrop-blur-sm border border-neutral-200/50 dark:border-neutral-700/50 rounded-2xl overflow-hidden">
    ...
    <div className="p-3 md:p-5">
      <div className="flex items-center justify-between mb-2">
        <div className="h-3 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-full w-16 animate-pulse" style={{ animationDelay: '0.1s' }}></div>
        <div className="h-2 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-full w-20 animate-pulse" style={{ animationDelay: '0.2s' }}></div>
      </div>
      <div className="h-5 md:h-6 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-lg mb-2 animate-pulse" style={{ animationDelay: '0.3s' }}></div>
      <div className="h-4 bg-neutral-200/50 dark:bg-neutral-700/50 rounded mb-3 w-3/4 animate-pulse" style={{ animationDelay: '0.4s' }}></div>
      <div className="flex gap-2 mb-3">
        <div className="h-5 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-full w-12 animate-pulse" style={{ animationDelay: '0.5s' }}></div>
        <div className="h-5 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-full w-16 animate-pulse" style={{ animationDelay: '0.6s' }}></div>
      </div>
      <div className="flex items-center justify-between pt-2 border-t border-neutral-200/30 dark:border-neutral-700/30">
        <div className="h-3 bg-neutral-200/50 dark:bg-neutral-700/50 rounded-full w-24 animate-pulse" style={{ animationDelay: '0.7s' }}></div>
        <div className="h-4 bg-neutral-200/50 dark:bg-neutral-700/50 rounded w-4 animate-pulse" style={{ animationDelay: '0.8s' }}></div>
      </div>
    </div>
  </div>
);
      ...
      <div>
        ...
        <div className="mb-6 md:mb-8 text-center">
          ...
          <p className="text-sm sm:text-base text-neutral-600 dark:text-neutral-400 mb-4 md:mb-6 px-2">
            Discover insights, tutorials, and thoughts about web development, technology, and the digital world.
          </p>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 justify-center max-w-5xl mx-auto px-2">
            ...
            <div className="relative flex-1 max-w-md">
              <label htmlFor="search-posts" className="sr-only">Search articles</label>
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className={`h-4 w-4 transition-colors ${isSearching ? 'text-amber-500' : 'text-neutral-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              />
              <span id="search-help" className="sr-only">Search through article titles, content, and tags</span>
              {isSearching && (
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2">
              ...
              <div className="relative">
                ...
                <div className="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none" aria-hidden="true">
            ...
            <div className="flex items-center justify-center py-4">
              <div className="flex items-center space-x-3 bg-white/60 dark:bg-neutral-800/60 backdrop-blur-xl px-4 py-2.5 rounded-full border border-neutral-200/50 dark:border-neutral-700/50 shadow-lg">
                ...
                <div className="flex flex-col">
                  <span className="text-neutral-700 dark:text-neutral-300 font-medium text-sm">Loading articles</span>
                  <span className="text-neutral-500 dark:text-neutral-500 text-xs">Please wait...</span>
                </div>
              </div>
            </div>
            {/* Skeleton loaders */}
                  ...
                  <article className="h-full bg-white/70 dark:bg-neutral-800/70 backdrop-blur-xl border border-neutral-200/50 dark:border-neutral-700/50 rounded-2xl md:rounded-3xl overflow-hidden hover:shadow-2xl hover:shadow-neutral-200/20 dark:hover:shadow-neutral-900/40 hover:scale-[1.02] hover:-translate-y-2 transition-all duration-500 group-hover:border-amber-500/30 animate-fadeInUp">
                    ...
                    {post.featuredImage ? (
                      ...
                      <div className="bg-gradient-to-br from-amber-50 via-amber-100 to-amber-200 dark:from-amber-900/20 dark:via-amber-800/20 dark:to-amber-700/20 flex items-center justify-center relative overflow-hidden h-48 md:h-56">
                        ...
                        <svg className="w-16 md:w-20 h-16 md:h-20 text-amber-500/40 relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="p-4 md:p-6 lg:p-8 flex-1 flex flex-col">
                      ...
                      <div className="flex items-center justify-between text-xs text-neutral-500 dark:text-neutral-400 mb-3 md:mb-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="font-medium text-xs md:text-sm">{post.author}</span>
                        </div>
                        <span className="font-medium text-xs">📅 {formatDate(post.createdAt.toString())}</span>
                      </div>
                ...
                <nav className="flex items-center space-x-1 md:space-x-2 bg-white/70 dark:bg-neutral-800/70 backdrop-blur-xl rounded-xl md:rounded-2xl p-1 md:p-2 border border-neutral-200/50 dark:border-neutral-700/50 shadow-lg shadow-neutral-200/20 dark:shadow-neutral-900/20">
                  ...
                  <div className="flex items-center space-x-1">
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => {
                      ...
                      if (showEllipsis) {
                        return (
                          <span key={`ellipsis-${page}`} className="px-2 md:px-3 py-2 text-neutral-400 dark:text-neutral-600 text-xs md:text-sm">
                            ⋯
                          </span>
                        );
                      }
