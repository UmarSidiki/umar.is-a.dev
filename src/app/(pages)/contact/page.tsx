        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-gradient-to-br from-white/80 via-neutral-50/60 to-white/70 dark:from-neutral-800/80 dark:via-neutral-900/60 dark:to-transparent backdrop-blur-xl border border-neutral-200/50 dark:border-neutral-700/50 rounded-3xl shadow-2xl shadow-neutral-200/20 dark:shadow-neutral-900/40 min-h-[calc(100vh-12rem)]">
            <div className="p-8 lg:p-12">
              ...
              </div>              <div className="grid lg:grid-cols-2 gap-12">                {/* Contact Information */}
                <div className="order-2 lg:order-1">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center space-x-3 text-sm">
                      ...
                      <span className="text-neutral-700 dark:text-neutral-300">24-48h response</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-8 p-4 bg-neutral-50/50 dark:bg-neutral-800/30 rounded-lg border border-neutral-200/30 dark:border-neutral-700/30">
                    <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                      ...
                      <span className="text-amber-600 dark:text-amber-400 font-medium"> Let&apos;s build something great together.</span>
                    </p>
                  </div>
                </div>{/* Contact Form */}
                <div className="order-1 lg:order-2">                  <div className="mb-6">
                    <h2 className="text-xl font-medium text-neutral-900 dark:text-white mb-2">
                      Send a message
                    </h2>
                    <p className="text-sm text-neutral-500 dark:text-neutral-400">
                  ...
                  {submitStatus === 'error' && (
                    ...
                    <div className="grid sm:grid-cols-2 gap-4">
                      <div>                        <input
                        ...
                        />
                        {errors.firstName && (
                          <p className="mt-1 text-xs text-red-600 dark:text-red-400 pl-1">{errors.firstName}</p>
                        )}
                      </div>
                      <div>                        <input
                          type="text"
                        ...
                        />
                        {errors.lastName && (
                          <p className="mt-1 text-xs text-red-600 dark:text-red-400 pl-1">{errors.lastName}</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div>                      <input
                      ...
                      />
                      {errors.email && (
                        <p className="mt-1 text-xs text-red-600 dark:text-red-400 pl-1">{errors.email}</p>
                      )}
                    </div>
                    ...
                    <div>                      <input
                      ...
                      />
                      {errors.subject && (
                        <p className="mt-1 text-xs text-red-600 dark:text-red-400 pl-1">{errors.subject}</p>
                      )}
                    </div>
                    ...
                    <div>                      <textarea
                      ...
                      />
                      {errors.message && (
                        <p className="mt-1 text-xs text-red-600 dark:text-red-400 pl-1">{errors.message}</p>
                      )}
                    </div>                    <button
                      type="submit"
                      disabled={isSubmitting}
