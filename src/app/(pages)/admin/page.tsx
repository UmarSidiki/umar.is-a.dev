...
const AdminDashboard = () => {
  ...
  }, [activeTab, fetchPosts, fetchComments, fetchStats]);
      ...
      {!authLoading && isAuthenticated && (
            ...
            <div className="relative z-10 mb-6 sm:mb-8">
              ...
              <div className="flex items-center justify-between mb-4 sm:hidden px-1">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <span className="text-base font-semibold text-neutral-900 dark:text-white block">
                      Admin Panel
                    </span>
                ...
                <button
                  ...
                  className="relative z-10 bg-red-500 hover:bg-red-600 active:bg-red-700 text-white px-4 py-2.5 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl flex items-center space-x-2 font-medium text-sm"
              ...
              <div className="hidden sm:flex items-center justify-between">
                <div>
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">
                    Manage your blog content, comments, and monitor website
                    analytics
                  </p>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <button
                    ...
                    className="relative z-10 bg-red-500 hover:bg-red-600 active:bg-red-700 text-white px-6 py-3 rounded-xl font-medium text-sm transition-all duration-200 flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                    title="Logout from admin panel"
                  >
                    <svg
                      className="w-4 h-4"
        ...
        <div className="relative z-10 mb-6 sm:mb-8">
              ...
              <div className="sm:hidden">
                <div className="flex space-x-1 bg-neutral-100/50 dark:bg-neutral-800/50 p-1.5 rounded-xl backdrop-blur-sm overflow-x-auto scrollbar-hide">
                  {[
                    { id: "dashboard", label: "Dashboard", icon: "📊" },
                    {
                      id: "create",
                      label: editingPost ? "Edit" : "Create",
                      icon: "✏️",
                    },
                    ...
                    <button
                      ...
                      className={`relative z-10 flex items-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm whitespace-nowrap transition-all duration-200 min-w-max ${
                        activeTab === tab.id
                ...
                <div className="flex space-x-1 bg-neutral-100/50 dark:bg-neutral-800/50 p-1 rounded-xl backdrop-blur-sm">
                  {[
                    ...
                    <button
                      ...
                      className={`relative z-10 flex items-center space-x-2 px-6 py-3 rounded-lg font-medium text-sm transition-all duration-200 ${
                        activeTab === tab.id
            ...
            <div className="relative z-20 bg-white/80 dark:bg-neutral-800/80 backdrop-blur-xl border border-neutral-200/50 dark:border-neutral-700/50 rounded-2xl sm:rounded-3xl shadow-2xl shadow-neutral-200/20 dark:shadow-neutral-900/40">
              ...
              {activeTab === "dashboard" && (
                <div className="p-4 sm:p-6 lg:p-8">
                  <h2 className="text-xl sm:text-2xl font-bold text-neutral-900 dark:text-white mb-6 sm:mb-8">
                    Website Overview
                  </h2>
                  ...
                  {loading ? (
                    ...
                    <div className="space-y-6 sm:space-y-8">
                      ...
                      {/* Top Categories */}
                      <div className="bg-neutral-50/50 dark:bg-neutral-700/30 rounded-2xl p-6 border border-neutral-200/50 dark:border-neutral-600/50 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          {stats.topCategories.length === 0 && (
                            <div className="col-span-full text-center text-neutral-500 dark:text-neutral-400 py-4">
                              No categories yet
                            </div>
                          )}
                        </div>
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-3 sm:space-y-0">
                    ...
                    {editingPost && (
                      <button
                        onClick={resetForm}
                        className="relative z-10 bg-neutral-500 hover:bg-neutral-600 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors w-full sm:w-auto"
                      >
                        Cancel Edit
                      </button>
                    )}
                  ...
                  >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 sm:px-4 py-2 sm:py-3 bg-white/60 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 text-neutral-900 dark:text-white transition-all text-sm sm:text-base"
                    ...
                    <div className="flex space-x-4">
                      <button
                        type="submit"
                        disabled={loading}
                        className="relative z-10 bg-amber-500 hover:bg-amber-600 disabled:bg-amber-400/50 text-white px-8 py-3 rounded-lg font-medium transition-all duration-200 disabled:cursor-not-allowed flex items-center"
                      >
                        {loading ? (
                          <>
                            <svg
                      ...
                      {formData.status === "published" && (
                        <button
                          ...
                          className="relative z-10 bg-neutral-500 hover:bg-neutral-600 text-white px-6 py-3 rounded-lg font-medium transition-colors"
                        >
                          Save as Draft
                        </button>
                      )}
                ...
                <div className="p-4 sm:p-6 lg:p-8">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 sm:mb-8 space-y-3 sm:space-y-0">
                    ...
                    <button
                      ...
                      className="relative z-10 bg-amber-500 hover:bg-amber-600 text-white px-4 py-2 rounded-lg font-medium text-sm transition-colors w-full sm:w-auto"
                    >
                      + New Post
                    </button>
                  </div>
                  ...
                  {/* Filters */}
                  <div className="mb-6 space-y-3 sm:space-y-4 lg:space-y-0 lg:flex lg:items-center lg:space-x-4">
                    <div className="flex-1">
                      <input
                        type="text"
                        ...
                        className="w-full px-3 sm:px-4 py-2 bg-white/60 dark:bg-neutral-800/60 border border-neutral-200 dark:border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm"
                      />
                    </div>
                                ...
                                <td className="py-4 px-6">
                                  <div className="flex items-center space-x-2">
                                    <button
                                      ...
                                      className="relative z-10 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium"
                                    >
                                      View
                                    </button>
                                    <button
                                      onClick={() => handleEdit(post._id)}
                                      className="relative z-10 text-amber-600 dark:text-amber-400 hover:text-amber-700 dark:hover:text-amber-300 text-sm font-medium"
                                    >
                                      Edit
                                    </button>
                                    <button
                                      onClick={() => handleDelete(post._id)}
                                      className="relative z-10 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 text-sm font-medium"
                                    >
                                      Delete
                                    </button>
                                  </div>
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex items-center space-x-2 ml-4">
                              {comment.status === "pending" && (
                                <>
                                  <button
                                    ...
                                    className="relative z-10 bg-green-500 hover:bg-green-600 text-white px-3 py-1 rounded-lg text-sm font-medium transition-colors"
                                  >
                                    Approve
                                  </button>
                                  <button
                                    ...
                                    className="relative z-10 bg-red-500 hover:bg-red-600 text-white px-3 py-1 rounded-lg text-sm font-medium transition-colors"
                                  >
                                    Reject
                                  </button>
                                </>
                              ...
                              <button
                                ...
                                className="relative z-10 bg-neutral-500 hover:bg-neutral-600 text-white px-3 py-1 rounded-lg text-sm font-medium transition-colors"
                              >
                                Delete
                              </button>
                            </div>
